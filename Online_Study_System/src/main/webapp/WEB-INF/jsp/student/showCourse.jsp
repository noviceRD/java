...
<body>
				    ...
				    <table class="table table-bordered">
							...
							<c:forEach  items="${courseList}" var="item">
								<tr>
									...
									<td>${item.video}</td>
									<td>
										<button class="btn btn-default btn-xs btn-info" onClick="return study()">
											<a id="chose-course" style="color: #fff" href="${ctx}/student/stuSelectedCourse?id=${item.id}">选课</a></button>
										<!--弹出框-->
									</td>
								</tr>
							</c:forEach>
	...
	<script language="javascript">
		function study(){
            var msg = "你确定要开始学习吗？是－选择确定，否-选择取消";
            if (confirm(msg)==true){
                window.location.href="stuSelectedCourse";
                return true;
            }else{
                return false;
            }
