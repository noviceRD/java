				    ...
				    <table class="table table-bordered">
							...
							<c:forEach  items="${StudentCourseList}" var="item">
									<tr>
										...
										<td>${item.courseVideo}</td>
										<td>
											<button class="btn btn-default btn-xs btn-info" onClick="location.href='${ctx}/student/study?id=${item.courseId}'">学习</button>
											<button class="btn btn-default btn-xs btn-info" onClick="location.href='${ctx}/student/startExam?id=${item.courseId}'">课后练习</button>
											<a class="btn btn-danger btn-xs" href="${ctx}/student/removeCourse?id=${item.courseId}" onclick="return checkConfirm()">退课</a>
										</td>
									</tr>
							</c:forEach>
					        </tbody>
